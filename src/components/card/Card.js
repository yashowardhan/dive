...
function MediaCard(props) {
  ...
  return (
    ...
    >
      <Typography 
        style={{ marginTop: '10px', marginBottom: '10px', marginLeft: '10px', fontFamily: 'monospace', fontWeight: 'bolder', fontSize: '1.4rem', textDecoration: 'underline'}}
      >
        PICK OF THE DAY!
      </Typography>
    ...
    <Typography 
        style={{ marginTop: '10px', marginBottom: '10px', marginLeft: '10px', fontFamily: 'monospace', fontWeight: 'bolder', fontSize: '1.4rem', fontStyle: 'bold', textDecoration: 'underline'}}
      >
        TOP READS: 
      </Typography>
      {
